...
try:
    ...
    cur = con.cursor()
    #cur.execute('select * from officers where officer_name in ("Rohit", "Sakshi", "Syush")')
    cur.execute('select * from officers where officer_name = "Rohit" or officer_name = "Sakshi" or officer_name =  "Syush" ')
    data = cur.fetchall()
